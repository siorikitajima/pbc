<template>
  <div class="albumBox" v-if="album">
        <router-link :to="'/album/' + album.AlbumID + '-'  + album.SlugName">
...
.albumBox .screen {
    ...
    top:0;
    left: 0;
    background: linear-gradient(0deg, rgba(0,0,0,0.7) 0%, rgba(0,0,0,0.2) 40%, rgba(0,0,0,0.2) 100%);
}
.albumBox:hover .screen {
